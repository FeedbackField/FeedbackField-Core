...
namespace FeedbackFieldTypeEmailBundle\Tests\Exports;
 ...
 */
class FeedbackFieldValueEmailRepositoryTest extends BaseTestWithDataBase
{
    ...
    function testGetCountWithFieldValue1() {
        ...
        $feedbackFieldDefinition->setType('Email');
        ...
        $feedback1FieldValue = new FeedbackFieldValueEmail();
        $feedback1FieldValue->setValue('Bob@example.com');
        ...
        $feedback2FieldValue = new FeedbackFieldValueEmail();
        $feedback2FieldValue->setValue('Bob@example.com');
        ...
        $feedbackRepo = $this->em->getRepository('FeedbackFieldTypeEmailBundle:FeedbackFieldValueEmail');
