...
namespace FeedbackFieldTypeEmailBundle\Repository;
 ...
 */
class FeedbackFieldValueEmailRepository extends EntityRepository
{
    ...
    public function getCountWithFieldValue(Project $project, DateRange $dateRange, FeedbackFieldDefinition $feedbackFieldDefinition) {
        $result = $this->getEntityManager()
            ->createQuery(
                ' SELECT count(f) AS c FROM FeedbackFieldTypeEmailBundle:FeedbackFieldValueEmail fv'.
                ' JOIN fv.feedback f ' .
